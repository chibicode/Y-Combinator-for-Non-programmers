...
const Svg1F436 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 36 36" {...props}>
    <path fill="#DD2E44" d="M15 27v6s0 3 3 3 3-3 3-3v-6h-6z" />
    <path
      fill="#BE1931"
      d="M15 33l.001.037c1.041-.035 2.016-.274 2.632-1.286.171-.281.563-.281.735 0 .616 1.011 1.591 1.251 2.632 1.286V27h-6v6z"
    />
    <path
      fill="#D99E82"
    ...
    <path
      fill="#292F33"
      d="M15 22.895c-1 1 2 4 3 4s4-3 3-4-5-1-6 0zM13 19c-1.1 0-2-.9-2-2v-2c0-1.1.9-2 2-2s2 .9 2 2v2c0 1.1-.9 2-2 2zm10 0c-1.1 0-2-.9-2-2v-2c0-1.1.9-2 2-2s2 .9 2 2v2c0 1.1-.9 2-2 2z"
    />
    <path
      fill="#662113"
    ...
    />
    <circle fill="#D99E82" cx={23.5} cy={25.5} r={0.5} />
    <circle fill="#D99E82" cx={11.5} cy={25.5} r={0.5} />
    <circle fill="#D99E82" cx={25.5} cy={27.5} r={0.5} />
    <circle fill="#D99E82" cx={10.5} cy={27.5} r={0.5} />
