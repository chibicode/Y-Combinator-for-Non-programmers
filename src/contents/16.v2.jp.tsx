        ...
        content: (
          <>
            ...
            <P>
              ...
              <Strong>
                それができる理由は、弁当箱を工夫すれば、四則演算を行ったり、条件分岐を行ったり、繰り返しを行うことができるからです。
              </Strong>
            </P>
            <EmojiSeparator
              emojis={['➕', '✖️', '🍱', '↕️', '🔁']}
            ...
            />
            <P>
              コンピュータサイエンスの中にはさまざまな分野がありますが、どの分野でも「
              <Em>
                計算機(コンピュータ)を工夫して、問題を解く」ことが命題になっています。
              </Em>
              たとえば、「
              <Strong>
            ...
            <P>
              長くなりましたが、コンピュータサイエンスを学ぶこと、すなわち計算機の工夫の仕方を学ぶことの面白さを、本稿で感じていただけたなら嬉しいなと思っています。
            </P>
          </>
        )
      },
        ...
        content: (
          <>
            ...
            <P>
              ...
              は、何でも計算できる弁当箱を村の外の人たちに売りさばき、大金持ちになりました。
            </P>
            <EmojiSeparator
              emojis={['🍱', '💰', '🤑', '💰', '🍱']}
              description={<>弁当箱を売りさばいて稼ぎまくるぞ！</>}
            />
            <P>
            ...
            />
            <P>
              そして、年頃になったサヤちゃんは、好きなアーティストのコンサートにもっと参戦するために、村を出ていきました。
            </P>
            <EmojiSeparator
              emojis={['👧🏻', '❤️', '👨‍🎤']}
            ...
            />
            <P>
              以上です！ここまでお付き合いくださり、本当にありがとうございました。
            </P>
          </>
        )
      }
