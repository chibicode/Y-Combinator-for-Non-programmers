            ...
            <>
              <P>
                ...
                <ExternalLink href="https://www.ycombinator.com/topcompanies/">
                  トップ100社の企業価値を合計すると10兆円以上になります(2018年10月時点)。これは同時期のソフトバンクグループと同じくらいです。
                </ExternalLink>
                。
              </P>
              <P>
              ...
              <Blockquote>
                ...
                <P>
                  ...
                  凄腕プログラマーがわたしたちのことを聞いたら、こう思うでしょう。「Yコンビネーターって名の起業家育成プログラムだって？最高じゃん！きっと、面白い人たちが集まっているに違いない」と。いっぽう、スーツの人たちは、Yコンビネーターと聞いても何のことやらさっぱり、となりますから。
                </P>
              </Blockquote>
              <P>
                <Strong>ざっくり言うと:</Strong>{' '}
                彼らは凄腕プログラマーの起業家に投資したかった。だから、「Yコンビネーター」という
                <Em>高度なプログラミング専門用語</Em>
                を起業家育成プログラムの名前にすることで、凄腕プログラマーを呼び寄せたのです。
              </P>
              <P>
                <Em>
