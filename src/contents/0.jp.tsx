        ...
        content: (
          <>
            ...
            <P>
              ...
              「上級者向けの題材でも、プログラミング抜きに学べるんだ」と思っていただくのが目標です。
            </P>
            <P>
              そうすることで、「
              <Em>
                プログラミングを勉強する気は<Strong>毛頭ない</Strong>
                けど、ソフトウェアについての理解を深めたい
              </Em>
              」という方向けに、コンピューターサイエンスを学ぶきっかけを作れたら良いなと思っています。
            </P>
          </>
        ),
        footer: {
          content: (
            <>
              <P>
                <InlineHeader>プログラミング勉強中の方へ:</InlineHeader>{' '}
                この記事を読んでもプログラミングは上達しません。ただ、もしも「プログラミングのついでに、コンピューターサイエンスも学んでみたい」とお考えなのであれば、ぜひ読み進めてくださると嬉しいです。
              </P>
            </>
          )
        }
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <P>
              筆者は米国の大学でコンピューターサイエンスを専攻したのですが、Yコンビネーターは大学3年生が学ぶ
              <Em>上級者向け</Em>
              の題材でした。
            </P>
            <P>
