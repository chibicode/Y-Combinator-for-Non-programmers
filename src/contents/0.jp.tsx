        ...
        content: (
          <>
            ...
            <P>
              ...
              <Em>
                医者にとっての医学のように、プログラムを設計する際に指針のひとつとなる
              </Em>
          ...
          content: (
            <>
              ...
              <P>
                ...
                です。加えて、そういった最新技術が学術論文になることは少ないです。
              </P>
            </>
          )
        }
      ...
      },
      {
        ...
        content: (
          <>
            ...
            />
            <P>
              だから、プログラミングをコンピュータサイエンスを学ぶ必須事項にしてしまうと、それだけで学ぶハードルがひとつ増えてしまいます。
            </P>
            <P>
              個人的には、
              <Em>
          ...
          content: (
            <>
              <P>
                ...
                に当てはまります。
                <Strong>
                  本稿は大人向けで、子供向けの内容ではありません。
                </Strong>
              </P>
              <P>
                対象が子供の場合は話が違います。
                <Em>
                  子供向けの学校教育の場合、大人よりは学びに使える時間が多いので、プログラミングとコンピュータサイエンスの両方を教えるべきだと思います。
                </Em>
              </P>
              <EmojiSeparator
                emojis={['👧🏻', '❤️', '💻']}
        ...
        content: (
          <>
            ...
            <P>
              ...
              ということを自覚してもらえるからです。「
              <Em>
                わたしでも難しい内容を理解できた。だったら、他の内容も学べるはずだ！
              </Em>
              」と思ってもらいたいのです。それが、「自分にもコンピュータサイエンスを学べるかも」という自信につながると考えています。
            </P>
            <EmojiSeparator
              nodes={[
                <Emoji>🤔</Emoji>,
