          ...
          content: (
            <>
              ...
              <P>
                ...
                <Strong>
                  「コンピューターサイエンスを学んでみたい」というきっかけをみなさんに提供すること
                </Strong>
                です。
                <Em>
                  「コンピューターサイエンスって面白い！」「自分でもわかるかも！」「もっと知りたい！」
                </Em>
                と思ってくださる方が増えたらいいなと思っています。
              </P>
              <P>
                これを読んでくださっているのが<Strong>中高生</Strong>
                の方でしたら、読後に「
                <Em>大学でコンピューターサイエンスを学んでみたい</Em>
                」と思ってもらえると嬉しいです。これを読んでくださっているのが
                <Strong>教員</Strong>
                の方でしたら、読後に「
          ...
          content: (
            <>
              ...
              <P>
                ...
                <Em>この記事に必要な数学知識は足し算と掛け算だけ</Em>
                です。九九より難しい数式は一切登場しません。
              </P>
              <P>
                最後に繰り返しますが、記事はすべて<Strong>無料</Strong>
                で公開しています。
              </P>
              <P>それでは、本題に入りましょう！</P>
            </>
