      ...
      cards={[
        {
          ...
          content: (
            <>
              ...
              <P>
                少々長いですが、章ごとにページを分けているので、途中で一時休憩することもできます。最後まで
                <Strong>無料</Strong>
                で公開しているので、楽しんでいただけると嬉しいです。
              </P>
            </>
          )
        },
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <P>
                きっかけさえ掴むことができれば、ネットに無料の教材が豊富にあるので、みずから学んでいけるようになります。これを読んでくださっているのが中高生の方でしたら、大学でコンピューターサイエンスを専攻してみるのも良いかもしれません。
              </P>
            </>
          )
        },
        {
          title: <>スマホで完結。プログラミングも数学も必要なし。</>,
          content: (
            <>
              {' '}
              <EmojiSeparator emojis={['😉', '📱', '🆗']} />
              ...
              <P>
                ...
                <Em>この記事で必要な数学の知識は足し算と掛け算だけ</Em>
                です。九九ができれば大丈夫です。数式も一切登場しません。
              </P>
              <P>
                また繰り返しますが、記事はすべて<Strong>無料</Strong>
                で公開しています。
              </P>
            </>
          )
        },
        {
          ...
          content: (
            <>
              ...
              <P>
                <InlineHeader>それでは本題に入りましょう！</InlineHeader>
