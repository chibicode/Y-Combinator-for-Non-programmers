      ...
      },
      {
        ...
        content: (
          <>
            ...
            <P>
              <Em>
                どれだけ計算機(現代ならコンピュータやスマホ)が進化しようと、それで行うことができる計算は、弁当箱でも行うことができる。これが、弁当箱は空想上の最強の計算機と言われる所以です。
                <Strong>
                  そしてこの事実は、(ここでは詳しく書きませんが)1930年代に研究者によって発見されました。
                </Strong>
              </Em>
            </P>
          </>
        ...
        content: (
          <>
            ...
            <P>
              ...
              <Strong>
                <H args={{ name: 'yCombinator' }} />
                は、シンプルな弁当箱の仕組みを工夫して、繰り返しを可能にするもの
              </Strong>
