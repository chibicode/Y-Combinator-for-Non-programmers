          ...
          content: (
            <>
              ...
              <P>
                ...
                」と考えた結果、完成したのが本稿です。だから、そういう方々に「
                <Em>知的に面白い</Em>
                」と思っていただくために、難易度はあえて高めに設定しました。
              </P>
              <P>
                しかし同時に、
                <Em>
                  せっかく時間をかけて書くのであれば、対象をそういう方々に限定せず、できるかぎり読者層の裾野を広げたい
                </Em>
                とも思いました。だから、難易度は妥協しないけれど、説明はできる限り平易にしようと心がけました。
              </P>
              <P>
                それでもだいぶ難しいのは承知の上ですが、
                <Em>
                  本稿を雰囲気だけでも楽しんでくださった方や、「よくわからないけど、コンピュータサイエンスって面白そう」と感じてくださった方が、ひとりでも多くいればいいな
                </Em>
                と思っています。
              </P>
              <Hr />
