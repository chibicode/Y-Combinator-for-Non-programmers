    ...
    cards={[
          ...
          content: (
            <>
              <P>
                ...
                。コンピュータ史に詳しい方のなかには、怒り心頭に発する方が出てくるかもしれません。
              </P>
            </>
          )
        }
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <EmojiSeparator emojis={['🤔', '💭', '❓']} />
            <P>
              空想上の計算機について考える研究者は、1930年代に次のような問いに取り組んでいました。(説明を大幅に単純化しています)
            </P>
            <Ol>
              <OlLi>
            ...
            <EmojiSeparator emojis={['🤔', '💭', '🍱']} />
            <P>
              何が何だか分からなくても大丈夫です。すぐに分かりやすく解説します！
            </P>
          </>
        )
      },
      {
        ...
        content: (
          <>
            <P>
              弁当箱が空想上の最強の計算機であるということはどういうことでしょうか？それは、どんな高性能なコンピュータが行うような計算も、理論上は弁当箱で行うことができるということ。たとえばスマホの顔認証。弁当箱の仕組みはものすごいシンプル。ルールはこれだけしかない。
            </P>
            <P>
              弁当箱がこのように複雑な計算をできる理由は、工夫をしているから。たとえばYコンビネータ。
            </P>
            <P>
              弁当箱が空想上の、なのは、(少なくとも当時は)物理的に弁当箱のような計算機を作ることができなかったから
            </P>
          </>
        )
      },
