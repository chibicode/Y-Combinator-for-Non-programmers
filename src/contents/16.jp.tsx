      ...
      },
      {
        ...
        content: (
          <>
            ...
            <P>
              それを説明するために、こちらの弁当箱をラムダ計算の記述に置き換えてみましょう。本稿の一番最初に紹介した弁当箱です。
            </P>
            <R.Ilpo />
            <P>
              <Em>
          ...
          content: (
            <>
              <P>
                ...
                ラムダ計算は厳密に言うと「計算機」というよりは「計算模型」です。また、ラムダ計算は「最強の計算機を作ろう」として作られたものではなく、「別の目的のために計算模型を作ったら、たまたま最強のものができてしまった」というほうが正しいです。
              </P>
              <P>
                <Em>
                  これらの違いは説明しにくいので、分かりやすくするためにあえて違いをぼかしています。
                </Em>
                このことを、
                <H args={{ name: 'computerScience' }} />
